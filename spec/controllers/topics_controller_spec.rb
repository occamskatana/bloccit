...
RSpec.describe TopicsController, type: :controller do
	...
	describe "POST create" do 
		it "returns http redirect" do 
			post :create, topic: {name: RandomData.random_sentence, body: RandomData.random_paragraph}
			expect(response).to redirect_to(new_session_path)
		end
	end
	...
	describe "PUT update" do 
		it "returns http redirect" do 
			...
			put :update, id: my_topic.id, topic: {name: new_name, body: new_body}
			expect(response).to redirect_to(new_session_path)
		end
	end
	...
	context "admin user" do 
		...
		before do 
			user = User.create!(name: "Bloccit User", email: "blahblah@blahblah.com", password: "helloworld", role: :admin)
			create_session(user)
		end
	...
	context "moderator user" do 
		...
		before do 
			user = User.create!(name: "Bloccit User", email: "blahblah@blahblah.com", password: "helloworld", role: :moderator)
			create_session(user)
		end
